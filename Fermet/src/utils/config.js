...
export const themeConfig = [
  {
    ...
    value: {
      theme: 'default',
      type: 'dark',
      settingsContainerColor: '#242528',
      navItemActive: '#2BD6A5',
      settingsSearchBar: '#242528',
      settingsPanelItemBackgroundColor: '#242528',
      settingsDropdownColor: '#242528',
      siteTextColor: '#F9F9F9',
      bgDesignColor: '43, 214, 165',
      glowWrapperColor: '43, 214, 165',
      switchColor: 'rgba(43, 214, 165, 0.1)',
      switchEnabledColor: '#2BD6A5',
      bgColor: '#1E1F22',
      bodyText: '#F9F9F9',
      urlBarBg: '#242528',
      urlBarText: '#F9F9F9',
      ...
      tabBarBorder: '#2BD6A5',
      ubBg: '#242528',
      ubHover: 'rgba(43, 214, 165, 0.1)',
      tooltipBg: '#242528',
      tooltipText: '#F9F9F9',
      hoverBg: 'rgba(43, 214, 165, 0.1)',
      activeBg: 'rgba(43, 214, 165, 0.2)',
      quickModalBgColor: '#242528',
      loadingSrBgColor: '#1E1F22',
      loadingIconBack: 'rgba(43, 214, 165, 0.2)',
      loadingIconFront: '#2BD6A5',
      paginationTextColor: '#F9F9F9',
      paginationBorderColor: '#2BD6A5',
      paginationBgColor: '#242528',
      paginationSelectedColor: '#2BD6A5',
...
export const densityConfig = [
  { option: 'Compact', value: { viewDensity: 'compact' } },
  { option: 'Default', value: { viewDensity: 'default' } },
  { option: 'Cozy', value: { viewDensity: 'cozy' } },
];
